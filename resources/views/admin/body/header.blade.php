            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                            ...
                            <img src="{{asset('backend/assets/images/BalanceBite.gif')}}" alt="logo-sm" height="22">
                        
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('backend/assets/images/BalanceBite.gif')}}" alt="logo-dark" height="20">
                    </span>
                </a>

                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{asset('backend/assets/images/BalanceBite.gif')}}" alt="logo-sm-light" height="50">
                    </span>
                    <span class="logo-lg">
                        <img src="{{asset('backend/assets/images/BalanceBite.gif')}}" alt="logo-light" height="80">
                    </span>
                </a>
            </div>
