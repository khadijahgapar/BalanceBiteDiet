        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <label for="example-text-input" class="col-sm-2 col-form-label">User Phone Number</label>
                        <div class="col-sm-10">
                            <input name="phone_no" class="form-control" type="text" value="{{$editData->phone_no}}" id="example-text-input">
                        </div>
                    </div>
                    <!-- end row -->
